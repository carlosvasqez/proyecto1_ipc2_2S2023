DROP DATABASE IF EXISTS bibliotecas_database;
CREATE DATABASE bibliotecas_database;
USE bibliotecas_database;
...
CREATE TABLE detalle_transporte_biblioteca (
	...
	CONSTRAINT PK_DETALLE_TRANSPORTE_BIBLIOTECA PRIMARY KEY (transporte_biblioteca_id, libro_isbn),
...
/*
 ...
 INSERT INTO detalle_transporte_biblioteca (transporte_biblioteca_id, libro_isbn, unidades) VALUES ('1','1','1');
	-- las 3 linea de abajo ya no
...
-- SOLICITUD DE REVOCACION DE SUSPENSION
/*
